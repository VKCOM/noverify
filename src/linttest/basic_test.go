...
function withSideEffects($value) {
  global $someVariable;
  $someVariable += $value;
  return $someVariable;
}
...
$example1 = [
    10 + 5 - 3 => 1,
    5 - 3 + 10 => 2 // Duplicate key 5 - 3 + 10 and 10 + 5 - 3
];

// binary * and / and %
$example2 = [
    10 * 20 / 4  => 1,
    50 => 2, // Duplicate key 50 and 10 * 20 / 4
    20 => 3,
    420 % 400 => 2 // Duplicate key 420 % 400 and 20
];
...
$example5 = [
  0b1001 | 0b0010 => 1,
  0b1011 | 0b0000 => 2, // Duplicate key 0b1011 | 0b0000 and 0b1001 | 0b0010
];

// bitwise XOR
$example6 = [
  0b1001 ^ 0b1010 => 1,
  0b1111 ^ 0b1100 => 2, // Duplicate key 0b1111 ^ 0b1100 and 0b1001 ^ 0b1010
];
...
$example7 = [
  -$someValue => 1,
  -1 * $someValue => 2, // Duplicate key -1 * $someValue and -$someValue
];
...
$example8 = [
  foo() | 0b1011 => 1,
  foo() | 0b1011 | 0b0000 => 2, // Duplicate key  foo() | 0b1011 | 0b0000 and foo() | 0b1011
];
...
$example9 = [
  ...
  $numbers[0b1011 | 0b0000] => 2, // Duplicate key $numbers[0b1011 | 0b0000] and $numbers[0b1001 | 0b0010]
];

// class const fetch
$example10 = [
  Boo::B1 * 10 => 1,
  Boo::B1 * 5 * 2 => 2, // Duplicate key Boo::B1 * 5 * 2 and Boo::B1 * 10
];
