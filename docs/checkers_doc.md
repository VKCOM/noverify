...
## Table of contents
 - Enabled by default
   ...
   - [`arraySyntax` checker](#-arraySyntax--checker)
   - [`assignOp` checker](#-assignOp--checker)
   - [`badTraitUse` checker](#-badTraitUse--checker)
   - [`bareTry` checker](#-bareTry--checker)
   - [`bitwiseOps` checker](#-bitwiseOps--checker)
   - [`callSimplify` checker](#-callSimplify--checker)
 ...
 - Disabled by default
   ...
   - [`propNullDefault` checker](#-propNullDefault--checker)
   - [`redundantCast` checker](#-redundantCast--checker)
   - [`trailingComma` checker](#-trailingComma--checker)
